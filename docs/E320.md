...
Make sure to use `--usrp-args "addr=192.168.20.4"` with the sfp interface address.
        ...
        sudo -E cmake_targets/ran_build/build/nr-uesoftmodem -O ue_usim.conf -E -r 106 --numerology 1 --band 78 -C 3619200000 -s 516 --sa --nokrnmod --ue-rxgain 120 --ue-txgain 0 --ue-max-power 0 --ue-fo-compensation
        sudo -E cmake_targets/ran_build/build/nr-softmodem -O gnb_b210_b78.conf -E --sa
