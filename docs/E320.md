...
# Step 1. Initial Setup (Management Interface)

To check if the device is recognized by UHD, run the following command
...
In the end, make sure the devices respond to ping.
